...
int main(int argc, char **argv)
{
    ...
    // Create a SDL window
    SDL_Window *window = SDL_CreateWindow("Hello, SDL2", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, width, height, SDL_WINDOW_RESIZABLE);
    ...
    SDL_Texture * image_texture = initialize_texture_from_file("original.jpg", renderer);
